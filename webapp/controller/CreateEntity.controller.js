sap.ui.define([
	"OpenTickets/controller/BaseController",
	...
	return BaseController.extend("OpenTickets.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("TICKETOPENSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("TICKETOPENSet", oData);
