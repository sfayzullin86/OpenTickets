sap.ui.define([
	...
	return BaseObject.extend("OpenTickets.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias OpenTickets.model.ListSelector
		 */
		 ...
		 * @return {OpenTickets.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
