		...
		onTheMasterPage: {
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "TICKETOPENSet (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'TICKETOPENSet (0)'");
						},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all TICKETOPENSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "TICKETOPENSet (" + iExpectedLength + ")"
								}),
								success: function() {
